...
import com.app.sportsappkotlin.Interface.MainPresenterImpl
import com.app.sportsappkotlin.Interface.Presenter
import com.app.sportsappkotlin.Utlis.CommonFunctions
import com.app.sportsappkotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), Presenter.MainPresenter.View {
    ...
    override fun onGetResult(responseGame: ResponseGame?) {
        ...
        binding.seeMore.setOnClickListener { view ->
            val gson = Gson()
            val intent = Intent(this@MainActivity, Details_Page::class.java)
