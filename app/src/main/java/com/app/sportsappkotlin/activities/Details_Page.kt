package com.app.sportsappkotlin.activities
...
import com.app.sportsappkotlin.Adapter.AdapterClickListener
import com.app.sportsappkotlin.Adapter.AdapterPlayer
import com.app.sportsappkotlin.R
import com.app.sportsappkotlin.Utlis.CommonFunctions
import com.app.sportsappkotlin.databinding.ActivityDetailsPageBinding
import com.app.sportsappkotlin.retrofit.Response.PlayerDataModelled
...
class Details_Page : AppCompatActivity() {
    ...
    fun initData() {
        ...
        binding.rvTeamOne.layoutManager =
            LinearLayoutManager(this@Details_Page, LinearLayoutManager.VERTICAL, false)
        binding.rvTeamOne.adapter =
            AdapterPlayer(playerList_teams_one, this@Details_Page, object : AdapterClickListener {
        ...
        binding.rvTeamTwo.adapter =
            AdapterPlayer(playerList_teams_two, this@Details_Page, object : AdapterClickListener {
                override fun onItemClick(view: View?, pos: Int, obj: Any?) {
                    val model: PlayerDataModelled = obj as PlayerDataModelled
                    showDialogProject(model)
                }
